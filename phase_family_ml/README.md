...
6. `phase_family_ml.train_students` distills the teacher to lookup/table and decision-tree students, adds a synthetic teacher-labeled history-tree experiment, and trains a scratch decision-tree baseline on the same history examples.
